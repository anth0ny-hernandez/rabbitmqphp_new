...
function databaseProcessor($request) {
    ...
    switch($request['type']) {
        ...
        case "enable2fa":
                ...
                if($answer === "yes") {
                    ...
                    if($updateStmt->execute()) {
                        ...
                        $selectEmailSql = "SELECT email FROM accounts 
                                            WHERE session_token = ?";
        ...
        case "verify2fa":
                ...
                $getOtp = "SELECT Expires, OTP, Enabled FROM accounts WHERE session_token = ?";
        ...
        case "login":
            ...
            $sql = "SELECT email, password, Enabled FROM accounts WHERE username = ?";
